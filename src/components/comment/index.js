...
export default function Comment(comment) {
  ...
  return (
      <TouchableOpacity onPress={() => handlePress()} style={{backgroundColor: 'white',  flexDirection: 'row', padding: 10, borderBottomWidth: 1, borderBottomColor: '#DDD'}}>
        <Image source={{uri: comment.user.avatar}} style={{width: 60, height: 60, borderRadius: 100}}/>
        <View style={{marginHorizontal: 10, width: 285}}>
          <View style={{flexDirection: 'row', marginBottom: 5, alignItems: 'center'}}>
            ...
            <Text style={{fontSize: 16, color: 'gray', marginLeft: 3}}>@{comment.user.username}</Text>
          </View>
